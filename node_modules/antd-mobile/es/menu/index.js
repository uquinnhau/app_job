    ...
    _createClass(Menu, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                Flex,
                { className: classnames((_classnames = {}, _defineProperty(_classnames, prefixCls, true), _defineProperty(_classnames, className, !!className), _classnames)), style: _extends({}, style, heightStyle), direction: 'column', align: 'stretch' },
                React.createElement(
                    Flex,
                    ...
                    React.createElement(
                        Flex.Item,
                        { style: heightStyle, role: 'tabpanel', 'aria-hidden': 'false', className: classnames(_defineProperty({}, MenuSelectContanerPrefixCls + '-submenu', true)) },
